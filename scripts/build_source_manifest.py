...
SOURCES = [
    ...
    # manual ones are rebuilt by hand and say so, because the tab's harvest
    # map is built on them and a reader of "every public pipeline" should see
    # that they do not refresh on the automated cycle.
    {
        "key": "enso",
        "file": "enso.json",
        "label": "NOAA CPC ENSO state: ONI, weekly Nino regions, event analogs",
        "cadence": "6-hourly fetch / CPC weekly and monthly upstream",
        "mode": "live",
    },
    {
        "key": "enso_indices",
        "file": "enso_indices.json",
        "label": "ENSO indices side by side: ONI, RONI, weekly Nino 3.4, BoM relative Nino 3.4, SOI",
        "cadence": "6-hourly fetch / weekly upstream",
        "mode": "live",
    },
    {
        "key": "enso_bulletins",
        "file": "enso_bulletins.json",
        "label": "Agency ENSO bulletins: NOAA CPC, BoM, IRI, WMO",
        "cadence": "6-hourly fetch / weekly and monthly upstream",
        "mode": "live",
    },
    {
        "key": "sst_anomaly",
        "file": "sst_anomaly.json",
        "label": "NOAA OISST v2.1 sea-surface anomaly grid (CoastWatch ERDDAP)",
        "cadence": "6-hourly fetch / daily upstream (1-2d lag, preliminary)",
        "mode": "live",
    },
    {
    ...
    {
        "key": "enso_model",
        "file": "enso_model.json",
        "label": "ENSO crop-yield response fit (FAOSTAT 1961-2024 x ONI)",
        "cadence": "manual rebuild (build_enso_model.py); FAOSTAT updates yearly",
        "mode": "manual",
    },
    {
        "key": "enso_exposure",
        "file": "enso_exposure.json",
        "label": "ENSO production exposure in tonnes (fit x USDA PSD)",
        "cadence": "manual rebuild (build_enso_exposure.py) after each USDA PSD release",
        "mode": "manual",
    },
    {
        "key": "crop_calendars",
        "file": "crop_calendars.json",
        "label": "USDA IPAD crop calendars, read from archived charts",
        "cadence": "manual; upstream retired",
        "mode": "manual",
    },
    {
        "key": "enso_regions",
        "file": "enso_regions.json",
        "label": "Published ENSO teleconnection regions, curated and cited",
        "cadence": "manual",
        "mode": "manual",
    },
    {
    ...
    },
    {
        ...
        "cadence": "manual, after each Panama Canal advisory",
        "mode": "manual",
    },
    {
        "key": "enso_econ",
        "file": "enso_econ.json",
        "label": "ENSO and prices: record, models, disagreement, curated and cited",
        "cadence": "manual",
        "mode": "manual",
    },
    {
        "key": "enso_mechanism",
        "file": "enso_mechanism.json",
        "label": "ENSO mechanism evidence: CPC, BoM, IRI, JMA citations",
        "cadence": "manual, after each CPC Diagnostic Discussion",
        "mode": "manual",
    },
    {
